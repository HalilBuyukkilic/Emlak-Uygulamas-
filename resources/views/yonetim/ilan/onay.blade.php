        ...
        <main id="main-container">
            ...
            <div class="bg-body-light">
                <div class="content content-full">
                    <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                        <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">{{$ayar->baslik. " | İlan Yönetimi"}}</h1>
                        <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                            <ol class="breadcrumb breadcrumb-alt">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="{{route('yonetim.ilan.onaybekleyen')}}">Onay Bekleyen İlanlar</a>
                                </li>
            ...
            <div class="content">
                ...
                <div class="p-3 bg-white rounded push">
                    <form action="{{route('yonetim.ilan.onaybekleyen')}}" method="post">
                        @csrf
                                    ...
                                    <div class="block-options">
                                        <a href="{{route('dashboard')}}" target="_blank">
                                            <button type="button" class="btn btn-success mr-1 mb-3">
                                                <i class="fa fa-fw fas fa-folder-plus mr-1"></i> Yeni İlan Ekle
                                            </button>
                                        </a>
                                    </div>
                                </div>
                                            ...
                                            @foreach($list as $entry)
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <img class="img-avatar img-avatar128" src="{{ $entry->resim->first()!=null ? asset('upload/image/ilan/'.$entry->resim->first()->resim) : '/assets/media/avatars/resimyok.png' }}" alt="">
                                                    </td>
                                                    <td class="font-w600">
                                                        <a href="{{route('ilan', $entry->slug)}}" target="_blank">{{$entry->baslik}}</a>
                                                    </td>
                                                    <td class="font-w600">
                                                    ...
                                                    <td class="text-center">
                                                        <div class="btn-group">
                                                            <a href="{{route('yonetim.ilan.onayla', $entry->id)}}">
                                                                <button type="button" class="btn btn-sm btn-primary" data-toggle="tooltip" title="Onayla" onclick="return confirm('İlanı Onaylamak İstediğinize Emin Misiniz?')">
                                                                    <i class="fa fa-check"></i>
                                                                </button>
                                                            </a>
                                                            <a href="{{route('yonetim.ilan.form', $entry->id)}}">
                                                                <button type="button" class="btn btn-sm btn-primary" data-toggle="tooltip" title="Düzenle">
                                                                    <i class="fa fa-pencil-alt"></i>
                                                                </button>
                                                            </a>
                                                            <a href="{{route('yonetim.ilan.sil', $entry->id)}}">
                                                                <button type="button" class="btn btn-sm btn-primary" data-toggle="tooltip" title="Sil" onclick="return confirm('İlanı Silmek İstediğinize Emin Misiniz? BU İŞLEM GERİ ALINAMAZ')">
