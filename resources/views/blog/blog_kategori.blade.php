...
@section('title', 'Toprak Konut - '.$blogkategori->kategori_adi.' Sektörel Haberler Blogu')
@section('meta', 'Toprak Konut - '.$blogkategori->kategori_adi.' Sektörel Haberler Blogu')
@section('content')
    <!--Breadcrumb-->
    <section>
            ...
            <div class="header-text mb-0">
                <div class="container">
                    <div class="text-center text-white">
                        <h1 class="">{{$blogkategori->kategori_adi}}</h1>
