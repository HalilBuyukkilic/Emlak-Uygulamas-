...
@include('katmanlar.menu.navbar1')
@yield('content')
...
<!--Map js -->
<script src="https://maps.google.com/maps/api/js?key=AIzaSyDFAjEWhUz022UYBgl3rVQ7OIoZgrf2O6s"></script>
<script src="/assets/plugins/map/jquery.axgmap.js"></script>
