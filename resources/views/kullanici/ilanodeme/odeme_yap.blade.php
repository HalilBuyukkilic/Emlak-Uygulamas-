        ...
        <div class="row">
            <div class="col-xl-8 col-lg-8 content-right-offset">
                ...
                <div class="billing-cycle margin-top-25">
                    ...
                    <form action="{{route('ilanlarim.yukselt.odeme')}}" method="POST" >
                        @csrf
                        <div class="col">
                            <div class="row">
                                ...
                                <div class="col-xl-12">
                                    <div class="submit-field">
                                        ...
                                        <input type="hidden" name="ilan_id" value="{{$ilan}}">


                                        @foreach($onecikarma as $da)
                                            <input type="hidden" name="onecikarma[]" value="{{$da}}">
                                        @endforeach

                                        <textarea name="acikadres" id="acikadres" cols="30" rows="4" placeholder="Fatura Adresinizi Giriniz" required>{{$user->acikadres}}</textarea>
                                    </div>
                                </div>
...
-->
                                ...
                                <div class="col-xl-12">
                                <button class="button ripple-effect mesaj-gonder margin-bottom-65 margin-top-20">Ödeme Yap</button>
                                </div>
                            </div>
                        </div>
                    </form>
            ...
            <div class="col-xl-4 col-lg-4 margin-top-0 margin-bottom-60">
                ...
                <div class="boxed-widget summary margin-top-0">
                    ...
                    <div class="boxed-widget-inner">
                        <ul>
                            <li>İlan Yükseltmesi <span>{{$tutar}} ₺</span></li>
